...
export const workflows: Workflow[] = [
  ...
  },
  {
    ...
    description: "Analisa deals abertos diariamente, detecta sinais de risco e notifica o dono do deal com a ação recomendada.",
    status: "active",
    trigger: { type: "schedule" },
    currentVersionId: "wf_deal_risk_alert_v1",
    totalRuns: 312,
    successRuns: 298,
    failedRuns: 3,
    waitingRuns: 11,
  ...
  {
    id: "wf_lead_auto_enrichment",
    name: "Lead Auto-Enrichment",
    description: "Enriquece automaticamente novos leads recebidos e calcula lead score e ICP fit.",
    status: "active",
    trigger: { type: "webhook" },
    currentVersionId: "wf_lead_auto_enrichment_v1",
    totalRuns: 204,
    successRuns: 197,
    failedRuns: 2,
    waitingRuns: 5,
